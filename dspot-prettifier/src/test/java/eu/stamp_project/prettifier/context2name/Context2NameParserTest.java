...
public class Context2NameParserTest {

    private static final String outputOfContext2Name = "Original name:\tf" + AmplificationHelper.LINE_SEPARATOR +
    ...
    public void testParsing() {
        ...
        final Context2NameParser context2NameParser = new Context2NameParser();
        String parse = context2NameParser.parse(outputOfContext2Name);
        assertEquals("testEqualslitString", parse);
        for (int i = 1; i < 11; i++) {
            parse = context2NameParser.parse(outputOfContext2Name);

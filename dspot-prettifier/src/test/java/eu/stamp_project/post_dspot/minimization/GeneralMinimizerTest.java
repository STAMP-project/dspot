...
public class GeneralMinimizerTest extends AbstractTest {
    ...
    public void testMinimizeInlineVariable() throws Exception {
        ...
        final CtMethod amplifiedTest = Utils.findMethod("fr.inria.amplified.AmplifiedTest", "amplifiedTest");
        System.out.println(amplifiedTest);
        final CtMethod<?> minimize = generalMinimizer.minimize(amplifiedTest);

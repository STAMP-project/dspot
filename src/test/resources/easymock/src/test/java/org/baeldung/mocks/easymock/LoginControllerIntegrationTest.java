...
public class LoginControllerIntegrationTest {
    ...
    public void assertTwoMethodsHaveBeenCalled() {
        org.baeldung.mocks.testCase.UserForm userForm = new org.baeldung.mocks.testCase.UserForm();
    ...
    public void mockAnObjectToPassAround() {
        org.baeldung.mocks.testCase.UserForm userForm = EasyMock.mock(org.baeldung.mocks.testCase.UserForm.class);
    ...
    public void argumentMatching() {
        ...
        userForm.username = "foo";
        // default matcher
        EasyMock.expect(loginService.login(EasyMock.isA(org.baeldung.mocks.testCase.UserForm.class))).andReturn(true);
        // complex matcher

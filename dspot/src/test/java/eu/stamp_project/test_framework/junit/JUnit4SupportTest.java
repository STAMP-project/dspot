 ...
 * on 07/11/18
 */
public class JUnit4SupportTest extends AbstractTest {
    ...
    public void test() throws Throwable {
        ...
        final TestFrameworkSupport testFrameworkSupport = TestFrameworkFactory.getTestFrameworkSupport(junitTest4);

        assertFalse(testFrameworkSupport.isTest(junitTest3.getMethods().stream().findFirst().get()));
        assertTrue(testFrameworkSupport.isTest(junitTest4.getMethods().stream().findFirst().get()));
    }
}

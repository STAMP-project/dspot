...
public class AssertionGeneratorUtilsTest extends AbstractTest {
    ...
    public void testOnLoops() throws Exception {
        ...
        assertEquals("@org.junit.Test(timeout = 10000)" + AmplificationHelper.LINE_SEPARATOR +
                        ...
                        "}",
                TestWithLogGenerator.createTestWithLog(
    ...
    public void testNoInstrumentationOnGeneratedObject() throws Exception {
        ...
        final List<CtMethod<?>> instrumentedAmplifiedTests = amplifiedMethods.stream()
                .map(method -> TestWithLogGenerator.createTestWithLog(method, "fr.inria.statementaddarray", Collections.emptyList()))
    ...
    public void testMultipleObservationsPoints() throws Exception {
        ...
        final CtMethod<?> testWithLog =
                TestWithLogGenerator.createTestWithLog(test1, "fr.inria.multipleobservations", Collections.emptyList());
    ...
    public void testCreateTestWithLogClassTargetAmplify() throws Exception {
        ...
        final CtMethod<?> testWithLog =
                TestWithLogGenerator.createTestWithLog(test1, "fr.inria.statementaddarray", Collections.emptyList());
    ...
    public void testCreateTestWithLog() throws Exception {
        ...
        final CtMethod<?> testWithLog =
                TestWithLogGenerator.createTestWithLog(test1, "fr.inria.sample", Collections.emptyList());
    ...
    public void testCreateTestWithLogWithDuplicatedStatement() throws Exception {
        ...
        final CtMethod<?> testWithLog =
                TestWithLogGenerator.createTestWithLog(test2, "fr.inria.sample", Collections.emptyList());

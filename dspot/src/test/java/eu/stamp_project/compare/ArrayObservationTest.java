...
public class ArrayObservationTest {
    ...
    public void testReferenceTypeArrayObservation() {
        ...
        eu.stamp_project.compare.ObjectLog.log(objectArray, "objectArray", "test");
        Map<String, Observation> observations = ObjectLog.getObservations();
        Map observation = observations.get("test").getObservationValues();
        assertTrue(observation.containsKey("((eu.stamp_project.compare.ArrayObservationTest.testObject[])objectArray)[0].getB()"));
        assertEquals(2,observation.get("((eu.stamp_project.compare.ArrayObservationTest.testObject[])objectArray)[0].getB()"));
        assertTrue(observation.containsKey("(objectArray)[1]"));
        assertNull(observation.get("(objectArray)[1]"));
        assertTrue(observation.containsKey("((eu.stamp_project.compare.ArrayObservationTest.testObjectChild[])objectArray)[2].getB()"));
        assertEquals(2,observation.get("((eu.stamp_project.compare.ArrayObservationTest.testObjectChild[])objectArray)[2].getB()"));
        assertTrue(observation.containsKey("((eu.stamp_project.compare.ArrayObservationTest.testObjectChild[])objectArray)[2].getC()"));
        assertEquals(3,observation.get("((eu.stamp_project.compare.ArrayObservationTest.testObjectChild[])objectArray)[2].getC()"));
        ...
        testObject[][][] jaggedObjectArray = {{},
                ...
                {}};
        ObjectLog.reset();
        eu.stamp_project.compare.ObjectLog.log(jaggedObjectArray, "jaggedObjectArray", "test");
        ...
        assertTrue(observation.containsKey("((eu.stamp_project.compare.ArrayObservationTest.testObject[][][])jaggedObjectArray)[2][1][1].getB()"));
        assertEquals(2,observation.get("((eu.stamp_project.compare.ArrayObservationTest.testObject[][][])jaggedObjectArray)[2][1][1].getB()"));
    }

...
public class Main {
	...
	public static void run(Configuration configuration) throws InvalidSdkException, Exception {
		InputConfiguration inputConfiguration = new TestInputConfiguration(configuration.pathToConfigurationFile);
		run(configuration, inputConfiguration);
	}

	public static void run(Configuration configuration, InputConfiguration inputConfiguration)
	...
	static void runExample() {
		try {
			InputConfiguration configuration = new TestInputConfiguration(

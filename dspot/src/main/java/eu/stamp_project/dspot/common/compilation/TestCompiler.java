...
public class TestCompiler {
     ...
     * Then, compile and run the test using {@link eu.stamp_project.dspot.common.compilation.TestCompiler#compileAndRun(CtType, DSpotCompiler, List)}
     ...
     * using the {@link eu.stamp_project.dspot.common.compilation.DSpotCompiler}.
